...
void print_all_actors_by_height(Actor actors[], int number_of_actors, int height)
{
    for (int i = 0; i < number_of_actors; ++i) 
    {
...
void print_all_actors_by_city(Actor actors[], int number_of_actors, char city[])
{
    for (int i = 0; i < number_of_actors; ++i) 
    {
        if (actors[i].birth_address.city == city)
            print_actor(stdout, actors + i);
    }
}
...
int main()
{
    ...
    print_all_actors_by_height(actors, number_of_actors, 181);
